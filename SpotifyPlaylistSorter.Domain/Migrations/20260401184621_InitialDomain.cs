        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AudioFeatures_EnergyLevel = table.Column<string>(type: "text", nullable: true),
                    AudioFeatures_EnergyDynamics = table.Column<string>(type: "text", nullable: true),
                    AudioFeatures_Bpm = table.Column<int>(type: "integer", nullable: true),
                    AudioFeatures_BpmRangeAdjusted = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrackArtist", x => new { x.ArtistsId, x.TracksId });
                    table.ForeignKey(
                        name: "FK_TrackArtist_Artists_ArtistsId",
                        column: x => x.ArtistsId,
                        principalTable: "Artists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrackArtist_Tracks_TracksId",
                        column: x => x.TracksId,
                        principalTable: "Tracks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Playlists_SpotifyPlaylistId",
                table: "Playlists",
